# Proyecto Transversal Innovate Tech - Grupo 5
...
- **Streaming:** Icecast2 y FFmpeg.
- **Base de Datos:** MariaDB con triggers de auditoría y Bot de Telegram.
- **Videoconferencia:** Jitsi (WebRTC).
